    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher'), ('parent', 'Parent'), ('school_admin', 'School Administrator'), ('admin', 'Administrator')], default='student', max_length=20)),
                ...
                ('current_form', models.PositiveSmallIntegerField(blank=True, null=True)),
